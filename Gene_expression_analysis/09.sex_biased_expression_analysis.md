...
* (1) the file indicating the genomic location (autosomes vs. X) location of transcripts: **trans_location25.txt**
* (2) the 3 tissue-specific files produced with **Sleuth** containing the list of differentially expressed genes between males and females: **DEgenes_GONAD_samples.txt**, **DEgenes_HEAD_samples.txt** and **DEgenes_CARCASS_samples.txt** (these files were produced in 04.GE_quantification_normalisation.md)
* expression summary files for each tissue
...
### LOAD diff exp genes
df <- read.table("~/Documents/MECOPTERA/post_hack_check_GE/DEgenes/GONADS/DEgenes_GONAD_samples.txt", head=T, sep="")
head(df)
str(df)
...
# write a new file
write.table(merged_df_qsignif ,"~/Documents/MECOPTERA/post_hack_check_GE/DEgenes/GONADS/GONADS_signif_GEgenes_merged_chrom_loc.txt")
```
...
# 3. Sex-bias gene expression analysis
...
df_signif <- read.table("~/Documents/MECOPTERA/post_hack_check_GE/DEgenes/GONADS/GONADS_signif_GEgenes_merged_chrom_loc.txt", head=T, sep="")
head(df_signif)
...
GE <-read.table("~/Documents/MECOPTERA/post_hack_check_GE/25scaffolds_032023/GE_GONADS/Normalised_GONADS_GE_merged_25_scaffolds_NO_filter_30052023.txt", head=T, sep="")
head(GE)
str(GE)
