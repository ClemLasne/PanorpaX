...
* (1) the file indicating the genomic location (autosomes vs. X) of each transcripts: `trans_location25.txt`. This file canbe found in the **Data Repository** `PanorpaX/Dataset S2: Transcriptome assembly and transcripts genomic location/`.

* (2) the tissue-specific list of differentially expressed genes between males and females `DEgenes_GONAD_samples.txt`. This file was produced by **Sleuth** (see step **04.GE_quantification_normalisation.md** for pipeline). This file can be found in the **Data Repository** `PanorpaX/Dataset S4: Gene expression and dosage compensation/sex_biased_expression/`

* (3) the gene expression summary files for this tissue `NonNormalised_merged_GE_25scaffolds_GONADS.txt`, also produced by Sleuth (see step **04.GE_quantification_normalisation.md**). This dataset can be found in the Data Repository `PanorpaX/Dataset S4: Gene expression and dosage compensation/GONADS/`
