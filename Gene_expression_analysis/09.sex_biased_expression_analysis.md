...
* (2) the tissue-specific file produced with **Sleuth** containing the list of differentially expressed genes between males and females: `DEgenes_GONAD_samples.txt`(produced in **04.GE_quantification_normalisation.md**)
* (3) expression summary files for each tissue (`NonNormalised_merged_GE_25scaffolds_GONADS.txt`, also produced in **04.GE_quantification_normalisation.md**)
