...
* (2) the 3 tissue-specific files produced with **Sleuth** containing the list of differentially expressed genes between males and females: **DEgenes_GONAD_samples.txt**, **DEgenes_HEAD_samples.txt** and **DEgenes_CARCASS_samples.txt**

# 1. Merge DEgenes_TISSUE_samples.txt with trans_location25.txt
...
# 2. Merge DEgenes_TISSUE_samples.txt with trans_location25.txt
