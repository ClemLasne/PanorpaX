...
* (1) the indexed transcriptome "indexed_panorpa500_transcriptome.idx" (produced in **03. Kallisto_transcriptome_indexing**)
...
Note that "DEgenes_HEADS_samples.txt", "DEgenes_GONADS_samples.txt", and "DEgenes_CARCASSES_samples.txt" will be used in step **09.sex_biased_expression_analysis**.
